      ...
      <Link href={href} className="block">
        <div className={cn("relative aspect-[4/5] overflow-hidden rounded-2xl bg-desert-100 shadow-soft transition-shadow duration-700 ease-luxury group-hover:shadow-luxury")}>
          ...
          <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); }}
            ...
            className="absolute right-5 top-5 grid h-10 w-10 place-items-center rounded-full bg-bone/80 backdrop-blur-md text-ink/70 opacity-0 translate-y-1 transition-all duration-700 ease-luxury group-hover:opacity-100 group-hover:translate-y-0 hover:text-emerald-700">
