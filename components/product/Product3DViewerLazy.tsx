...
interface Product3DViewerLazyProps {
  model?: Model3D;
  swatch: string;
  caption?: string;
...
const Viewer = dynamic(() => import("./Product3DViewer"), {
  ssr: false,
  loading: () => <Loading />,
});

export function Product3DViewerLazy(props: Product3DViewerLazyProps) {
  return <Viewer {...props} />;
}

function Loading() {
  return (
    <div className="relative aspect-[4/5] overflow-hidden rounded-2xl shadow-soft bg-desert-100">
